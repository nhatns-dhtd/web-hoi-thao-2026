  ...
  if (!topic) {
    return (
      <div className="text-center py-20">
        ...
        <Link to="/introduction" className="mt-8 inline-block bg-teal-600 text-white font-bold py-3 px-6 rounded-lg hover:bg-teal-700 transition-colors">
            Back to Topics
        </Link>
      </div>
    );
    ...
    <div className="max-w-4xl mx-auto">
      <div className="bg-slate-800/40 backdrop-blur-sm rounded-lg shadow-xl border border-slate-700/50 overflow-hidden">
        ...
        <div className="p-8 md:p-12">
            <h1 className="text-2xl md:text-3xl md:text-4xl font-bold text-teal-100 mb-6">{topic.title}</h1>
            <div 
