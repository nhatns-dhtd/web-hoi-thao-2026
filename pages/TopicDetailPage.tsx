...
const TopicDetailPage: React.FC = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="bg-surface backdrop-blur-xs rounded-lg shadow-xl border border-line/50 overflow-hidden">
        ...
        <div className="p-8 md:p-12">
            ...
            >
             ...
             <Link to="/introduction" className="mt-10 inline-block bg-stone-700/50 text-stone-100 font-bold py-3 px-6 rounded-lg hover:bg-stone-600/50 transition-colors border border-line-strong">
